...
*/
package ejercicio_herencia_ex_02;

import ejercicio_herencia_ex_02.entidades.Edificio;
import ejercicio_herencia_ex_02.entidades.servicios.MainServicio;
 ...
 * @author Walter
 */
public class Ejercicio_Herencia_Ex_02 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        System.out.println("Este programa calcula la superficio y volumen de 4 edificios.");
        ArrayList<Edificio> edificios = new ArrayList();
        
        edificios=MainServicio.LlenarLista(edificios);
        MainServicio.MostrarLista(edificios);
    }
